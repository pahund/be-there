...
chrome.commands.onCommand.addListener((command) => {
  ...
  switch (command) {
    case 'open_url1':
      console.log("Navigating to open MDE UI pull requests on GitHub Enterprise");
      navigateTo('https://github.es.ecg.tools/mobile-de/mde-ui/pulls?q=is%3Apr+is%3Aopen+');
      break;
    case 'open_url2':
